...
export default function Portfolio() {
  ...
  return (
    <div className="min-h-screen bg-[#F8FAFC] text-slate-900 font-sans transition-colors duration-300 selection:bg-blue-100 selection:text-blue-700">
      <nav className="fixed w-full bg-white/70 backdrop-blur-md border-b border-slate-200 z-50">
  <div className="max-w-6xl mx-auto px-6 h-16 flex items-center justify-between">
    <motion.span 
      initial={{ opacity: 0, x: -10 }} 
      animate={{ opacity: 1, x: 0 }} 
      className="font-bold text-2xl tracking-tighter text-blue-600 italic"
    >
      TW.
    </motion.span>
    ...
    <div className="flex items-center gap-4 md:gap-8">
      <div className="hidden md:flex gap-8 text-sm font-semibold text-slate-600">
        <a href="#experience" className="hover:text-blue-600 transition-all hover:translate-y-[-2px]">Experience</a>
        <a href="#projects" className="hover:text-blue-600 transition-all hover:translate-y-[-2px]">Projects</a>
        <a href="#skills" className="hover:text-blue-600 transition-all hover:translate-y-[-2px]">Skills</a>
      </div>

      <button className="md:hidden p-2 text-slate-600 transition-transform active:scale-90" onClick={() => setIsMenuOpen(!isMenuOpen)}>
        {isMenuOpen ? <X size={24} /> : <Menu size={24} />}
      </button>
    </div>
  </div>

  {/* MOBILE MENU DENGAN ANIMASI FLAWLESS */}
  <AnimatePresence>
    {isMenuOpen && (
      <motion.div 
        ...
        <div className="px-6 py-6 space-y-4">
          {['experience', 'projects', 'skills'].map((item, index) => (
            <motion.a
              ...
              className="block font-bold text-slate-700 hover:text-blue-600 transition-colors capitalize text-lg"
            >
              {item}
            </motion.a>
          ))}
      ...
      <header className="max-w-6xl mx-auto pt-32 md:pt-48 pb-20 px-6">
        <div className="grid md:grid-cols-2 gap-12 items-center text-center md:text-left">
          ...
          >
            <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-blue-50 text-blue-600 text-xs font-bold mb-6 border border-blue-100 shadow-sm">
            ...
            <p className="mt-6 text-lg md:text-xl text-slate-600 leading-relaxed max-w-lg mx-auto md:mx-0">
              Software Development Supervisor at <span className="font-semibold text-slate-800">Indomaret Group</span>. 
            ...
            <div className="mt-10 flex flex-wrap justify-center md:justify-start gap-4">
              <a href="https://linkedin.com/in/timothywjya28/" target="_blank" rel="noopener noreferrer" className="flex items-center gap-2 bg-blue-600 text-white px-8 py-4 rounded-2xl hover:bg-blue-700 transition shadow-lg shadow-blue-200 font-bold">
                <Linkedin size={20} /> LinkedIn
              </a>
              <a href="https://github.com/timothywjya" target="_blank" rel="noopener noreferrer" className="flex items-center gap-2 bg-white border border-slate-200 px-8 py-4 rounded-2xl hover:bg-slate-50 transition font-bold shadow-sm">
                <Github size={20} /> GitHub
              </a>
            </div>
          </motion.div>

          {/* Right Side Card - Tetap gelap sedikit untuk kontras elegan */}
          <motion.div 
            initial={{ opacity: 0, scale: 0.8 }}
            animate={{ opacity: 1, scale: 1 }}
            transition={{ duration: 0.8 }}
            className="order-1 md:order-2 relative px-4"
          >
            <div className="absolute -inset-10 bg-blue-200 rounded-full blur-3xl opacity-30 animate-pulse"></div>
            ...
            <div className="group grid md:grid-cols-4 gap-4 md:gap-8">
              ...
              <div className="md:col-span-3">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 mb-8">
                  <div className="p-4 rounded-xl bg-slate-50 border border-slate-100 shadow-sm hover:border-blue-200 transition-colors">
                    <p className="font-bold text-sm italic underline text-blue-600">Enterprise Migration </p>
                  ...
                  <div className="p-4 rounded-xl bg-slate-50 border border-slate-100 shadow-sm hover:border-blue-200 transition-colors">
                    <p className="font-bold text-sm italic underline text-blue-600">System Automation </p>
            ...
            <div className="group grid md:grid-cols-4 gap-4 md:gap-8">
              ...
              <div className="md:col-span-3">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                  ...
                  <div className="p-4 rounded-xl bg-slate-50 border border-slate-100 shadow-sm hover:border-blue-200 transition-colors">
                    <p className="font-bold text-sm italic underline text-blue-600">Process Automation</p>
      ...
      >
        <div className="max-w-6xl mx-auto px-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            ...
            <div className="bg-white p-8 rounded-[2.5rem] border border-slate-200 hover:shadow-2xl transition-all group">
              <div className="flex justify-between items-start mb-6">
                <div className="p-3 bg-blue-50 text-blue-600 rounded-2xl group-hover:bg-blue-600 group-hover:text-white transition-colors">
                  <Globe size={24} />
                </div>
                <span className="text-[10px] font-bold bg-blue-100 text-blue-700 px-3 py-1 rounded-full uppercase tracking-widest">Enterprise ERP</span>
              </div>
              ...
              <div className="flex flex-wrap gap-2">
                {['Laravel', 'Oracle', 'PostgreSQL', 'Automated Jobs'].map(t => (
                  <span key={t} className="px-2 py-1 bg-slate-100 rounded text-[10px] font-bold border border-slate-200">{t}</span>
                ))}
              </div>
            </div>
            ...
            <div className="bg-white p-8 rounded-[2.5rem] border border-slate-200 hover:shadow-2xl transition-all group">
              <div className="flex justify-between items-start mb-6">
                ...
                <span className="text-[10px] font-bold bg-emerald-100 text-emerald-700 px-3 py-1 rounded-full uppercase tracking-widest">Supply Chain</span>
              </div>
            ...
            <div className="bg-white p-8 rounded-[2.5rem] border border-slate-200 hover:shadow-2xl transition-all group">
              <div className="flex justify-between items-start mb-6">
                ...
                <span className="text-[10px] font-bold bg-purple-100 text-purple-700 px-3 py-1 rounded-full uppercase tracking-widest">Market Expansion</span>
              </div>
            ...
            {/* 4. Log Management */}
            <div className="bg-slate-900 text-white p-8 rounded-[2.5rem] border border-blue-500/30 hover:shadow-2xl transition-all group">
              <div className="flex justify-between items-start mb-6">
      ...
      <motion.section 
        ...
        viewport={fadeInUp.viewport}
        transition={fadeInUp.transition}
        className="py-24 bg-blue-600 text-white rounded-[3rem] mx-4 mb-10 shadow-2xl shadow-blue-200"
      >
        <div className="max-w-6xl mx-auto px-6">
          <div className="flex flex-col md:flex-row md:items-end justify-between mb-16 gap-6">
            <div>
              <h2 className="text-3xl font-bold flex items-center gap-3 italic">
                <Award className="text-white" /> Academic & Tech Profile
              </h2>
              <p className="text-blue-100 mt-2 italic">B.S. in Computer Science | Satya Wacana Christian University (2022)</p>
            </div>
            <div className="bg-blue-500/30 p-6 rounded-3xl border border-white/20 text-center backdrop-blur-sm">
              <p className="text-xs font-bold text-blue-100 uppercase tracking-widest mb-1">Honors GPA</p>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-12">
            <div className="space-y-6">
              <h4 className="flex items-center gap-2 text-white font-bold uppercase tracking-widest text-sm italic underline">
                <Terminal size={18} /> Languages
              </h4>
              <div className="flex flex-wrap gap-2">
                {['PHP', 'Node.js', 'Next.js', 'Express', 'TypeScript', 'VB.NET', 'SQL'].map(s => (
                  <span key={s} className="px-4 py-2 bg-white/10 rounded-xl text-sm border border-white/20 backdrop-blur-md">{s}</span>
                ))}
              </div>
            </div>
      ...
      <footer className="py-20 text-center">
        ...
        <p className="text-slate-500 text-sm font-medium italic underline">
